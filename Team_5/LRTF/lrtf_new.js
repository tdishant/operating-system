...
function addRow() {
    let arrTime = document.getElementById("arrival-time-lrtf").value;
    let burTime = document.getElementById("burst-time-lrtf").value;
    if(arrTime == "" || burTime == ""){
        ...
        document.getElementById("burst-time-lrtf").value="";
        document.getElementById("arrival-time-lrtf").value="";
    }
}
...
function calculateAverages(n, CT, TAT, WT, RT){
    ...
    document.getElementById("avg-comp-time-lrtf").value = avgCT.toPrecision(3);
    document.getElementById("avg-turn-time-lrtf").value = avgTAT.toPrecision(3);
    document.getElementById("avg-resp-time-lrtf").value = avgRT.toPrecision(3);
    document.getElementById("avg-wt-time-lrtf").value = avgWT.toPrecision(3);
