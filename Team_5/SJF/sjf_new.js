...
function calculateAverages(n, CT, TAT, WT, RT) {
    ...
    document.getElementById("avg-comp-time-sjf").value = avgCT.toPrecision(3);
    document.getElementById("avg-turn-time-sjf").value = avgTAT.toPrecision(3);
    document.getElementById("avg-resp-time-sjf").value = avgRT.toPrecision(3);
    document.getElementById("avg-wt-time-sjf").value = avgWT.toPrecision(3);
}
