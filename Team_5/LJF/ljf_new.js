...
function addRow() {
    let arrTime = document.getElementById("arrival-time-ljf").value;
    let burTime = document.getElementById("burst-time-ljf").value;
    if (arrTime == "" || burTime == "") {
        ...
        document.getElementById("burst-time-ljf").value = "";
        document.getElementById("arrival-time-ljf").value = "";
    }
}
...
function calculateAverages(n, CT, TAT, WT, RT) {
    ...
    document.getElementById("avg-comp-time-ljf").value = avgCT.toPrecision(3);
    document.getElementById("avg-turn-time-ljf").value = avgTAT.toPrecision(3);
    document.getElementById("avg-resp-time-ljf").value = avgRT.toPrecision(3);
    document.getElementById("avg-wt-time-ljf").value = avgWT.toPrecision(3);
}
